...
function GalleryHero() {
  return (
    <section className="relative overflow-hidden pt-12 pb-16 md:pt-16 md:pb-24 bg-gradient-to-b from-blue-50/60 via-white to-white">
      ...
      <div className="aria-hidden:true pointer-events-none absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-96 overflow-hidden">
        ...
        <div className="absolute top-32 left-1/3 w-80 h-80 rounded-full bg-sky-200/40 blur-3xl opacity-50" />
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        <motion.h1
          ...
          className="text-3xl sm:text-5xl md:text-6xl font-extrabold text-gray-900 tracking-tight leading-tight md:leading-none mb-6"
        >
          Our Journey of <span className="bg-gradient-to-r from-primary-600 via-primary-500 to-teal-500 bg-clip-text text-transparent">Pure Water</span>
        </motion.h1>
        ...
        <motion.p
          ...
          className="max-w-[700px] mx-auto text-base sm:text-lg text-gray-600 leading-relaxed font-normal mb-8"
        >
